...
<div class="page-wrap">
    <div class="hero-card">
        <h2 class="text-2xl font-semibold" style="margin:0;">Tambah Data Keluarga</h2>
        <p class="text-sm" style="margin:6px 0 0;color:rgba(255,255,255,.84);">Isi identitas keluarga baru untuk pengelompokan data warga.</p>
    </div>
    ...
    <div class="panel-card">
        ...
        <form action="{{ route('keluarga.store') }}" method="POST" class="space-y-4">
            @csrf
