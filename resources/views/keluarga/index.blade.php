...
<div class="page-wrap space-y-6">
    <div class="hero-card">
        ...
        <a href="{{ route('keluarga.create') }}" class="btn-danger">
            + Tambah Keluarga
        </a>
    </div>
    ...
    <div class="panel-card">
        <div class="panel-head">
            <form action="{{ route('keluarga.index') }}" method="GET" style="display:flex;gap:8px;max-width:600px;flex:1;">
                <input
                    type="text"
                    name="q"
                    value="{{ $search ?? '' }}"
                ...
                <a href="{{ route('keluarga.index') }}" class="btn-secondary">Reset</a>
            </form>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="flex flex-wrap gap-2">
                                    <a href="{{ route('keluarga.edit', $keluarga->id) }}" class="btn-muted">Edit</a>
                                    <form action="{{ route('keluarga.destroy', $keluarga->id) }}" method="POST" onsubmit="return confirm('Hapus data keluarga ini?')" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="6" style="padding:16px;text-align:center;color:#64748b;">Belum ada data keluarga.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
