...
<div class="page-wrap">
	<div class="hero-card">
		<h2 class="text-2xl font-semibold" style="margin:0;">Tambah Data Warga</h2>
		<p class="text-sm" style="margin:6px 0 0;color:rgba(255,255,255,.84);">Isi data warga baru ke dalam sistem.</p>
	</div>
		...
		<form action="{{ route('warga.store') }}" method="POST" class="space-y-4">
				...
				<div>
					...
					>
						...
						@foreach ($keluargas as $keluarga)
							<option value="{{ $keluarga->id }}" @selected(old('keluarga_id') == $keluarga->id)>
			...
			<div>
				...
				<input 
					...
					required 
					class="field-input"
					placeholder="Contoh: 1234567890123451"
				>
			</div>
			...
			<div class="pt-4 border-t border-gray-200">
				<div class="text-sm text-gray-600 mb-3">Pastikan NIK belum pernah digunakan.</div>
