...
<div class="page-wrap space-y-6">
	...
	<div style="margin-top:16px; margin-bottom:16px; display:flex; justify-content:flex-end;">
		<form method="POST" action="{{ route('pembayaran.reminder-whatsapp.all') }}" onsubmit="return confirm('Anda yakin ingin mengirimkan pesan tagihan via WhatsApp (Fonnte) ke SEMUA warga yang tampil di tabel ini (belum lunas)?')">
			@csrf
			<input type="hidden" name="kategori" value="{{ $selectedKategori ?? 'wajib' }}">
